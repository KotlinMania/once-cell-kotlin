...
kotlin {
    ...
    val xcf = XCFramework("OnceCell")

    macosArm64 {
        binaries.framework { baseName = "OnceCell"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "OnceCell"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "OnceCell"
        flattenPackage = "io.github.kotlinmania.oncecell"
    }

    android {
        namespace = "io.github.kotlinmania.oncecell"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "once-cell-kotlin", version.toString())

    pom {
        name.set("once-cell-kotlin")
        description.set("Kotlin Multiplatform port of matklad/once_cell - Single assignment cells and lazy values")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/once-cell-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/once-cell-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/once-cell-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/once-cell-kotlin.git")
        }
    }
}
...
val codeqlCompileJvm = tasks.register<JavaExec>("codeqlCompileJvm") {
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            val sentinelFile = sentinelDir.get().asFile.resolve("io/github/kotlinmania/oncecell/codeql/CodeqlEmptySentinel.kt")
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.oncecell.codeql
