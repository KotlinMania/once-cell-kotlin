...
This file is the quick-reference operating contract for once-cell-kotlin. The longer
...
once-cell-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`once_cell`](https://crates.io/crates/once_cell). Upstream Rust is the behavioral oracle while the
